...
class EventItem extends React.Component {
    constructor(props, context) {
        ...
        this.state = {
            firstname: (this.props.event.firstname || ''),
            lastname: (this.props.event.lastname || ''),
            publish: (this.props.event.publish || false),
        };
    ...
    listener() {
        ...
        _.merge(this.state, this.store.events[this.props.storeKey]);
